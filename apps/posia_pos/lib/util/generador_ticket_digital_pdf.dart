...
double _calcularAltoPagina(TicketDigitalContenido contenido) {
  ...
  final metaExtra =
      contenido.campos.length + (contenido.nombreCliente != null ? 1 : 0);
  alto += metaExtra * 8;
  alto += divisor;
...
pw.Widget _filaMeta(String etiqueta, String valor) {
  return pw.Padding(
    ...
    child: pw.Text(
      '$etiqueta: $valor',
      style: const pw.TextStyle(fontSize: 8, color: _grisOscuro),
    ),
  );
}
