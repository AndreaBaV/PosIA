...
class _PantallaAsistenciaAdminState
    extends ConsumerState<PantallaAsistenciaAdmin> {
  String? _pinActivo;
  DateTime? _expiraPin;
  ...
  Widget build(BuildContext context) {
    ...
    final tiendaId = ref.watch(tiendaActivaIdProvider).value;
    final nombreTienda = tiendaId == null
        ? null
        : (tiendasAsync.value ?? const <String, String>{})[tiendaId];
    return Scaffold(
      appBar: AppBar(
              ...
              child: Column(
                children: [
                  ...
                  const SizedBox(height: 8),
									Text(
										nombreTienda == null
											? 'Válido 10 minutos. El empleado marca con este PIN '
												'dentro del radio GPS de la tienda.'
											: 'PIN de $nombreTienda. El empleado lo usa en el '
												'celular estando dentro del radio GPS de esa tienda.',
            ...
            data: (entradas) {
              ...
              return Column(
                children: entradas.map((e) {
                  ...
                  final hora = e.entradaEn.toLocal().toString().substring(
                    11,
                    16,
                  );
                  final salida = e.salidaEn?.toLocal().toString().substring(
                    11,
                    16,
                  );
...
final _usuariosNombresProvider = FutureProvider<Map<String, String>>((
  ref,
) async {
...
final _tiendasNombresProvider = FutureProvider<Map<String, String>>((
  ref,
) async {
  final servicio = await ref.watch(servicioAdminProvider.future);
